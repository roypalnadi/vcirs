...
<div class="relative flex items-top justify-center min-h-screen bg-gray-100 dark:bg-gray-900 sm:items-center py-4 sm:pt-0">
    ...
    <form id="regForm" action="{{route('save')}}" method="POST">
        ...
        <div class="tab">
            <p><b>Gejala: </b></p>
            <b><input value="{{$gejala->deskripsi ?? null}}" readonly></b>
            <div style="margin-top: 20px">
                <p><b>Jawaban: </b></p>
                <p><select name="pilihan[]" id="">
        ...
        @endforeach
        <div class="tab"><b>Nama Penginput:</b>
            <p><input placeholder="xxxxx xxxxx xxx" oninput="this.className = ''" name="name"></p>
        </div>
